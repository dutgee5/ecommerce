...
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_productId_product_id_fk" FOREIGN KEY ("productId") REFERENCES "public"."product"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
